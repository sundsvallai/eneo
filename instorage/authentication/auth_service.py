...
from instorage.main.config import (
    get_api_key_length,
    get_jwt_algorithm,
    get_jwt_audience,
    get_jwt_expiry_time_minutes,
    get_jwt_secret,
)
from instorage.main.exceptions import AuthenticationException
from instorage.users.user import UserBase, UserInDB
...
class AuthService:
    ...
    def _generate_api_key(self) -> str:
        return secrets.token_hex(get_api_key_length())
    ...
    async def create_user_api_key(
        self, prefix: str, user_id: int, delete_old: bool = True
    ):
