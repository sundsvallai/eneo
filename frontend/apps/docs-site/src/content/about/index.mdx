...
<EneoLogo className="h-12" />

**Democratic AI Platform for the Public Sector**

<div className="[&_p_img]:inline-block pt-4">
...
<div align="center">
<img src="/eneo_startpage.png" alt="Eneo Personal Assistant Interface" width="800"/>
<p><em>Personal AI Assistant with customizable models and real-time chat interface</em></p>
</div>

<div align="center">
<img src="/eneo_space.png" alt="Eneo Collaborative Spaces" width="800"/>
